...
exports.user_deposit_handler = void 0;
...
var user_deposit_handler = function (logger, log_params) { return __awaiter(void 0, void 0, void 0, function () {
    var abi, log, sender, user, referrer, deposit_amount, current_user, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                referrer = ethers_1.ethers.utils.getAddress(log.args["referrer"]);
                deposit_amount = log.args["amount"].toString();
                _a.label = 1;
            case 1:
                _a.trys.push([1, 5, , 6]);
                return [4 /*yield*/, (0, transaction_history_1.save_tx)({
                        ...
                        category: transaction_category_1.TransactionCategory.DEPOSIT,
                        timestamp: log_params.metadata.timestamp,
                        tx_hash: log_params.raw_log.transactionHash,
                    })];
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, update_user_info_1.update_user_info)(user, deposit_amount, referrer, true, false)];
            case 3:
                current_user = _a.sent();
                return [4 /*yield*/, (0, update_user_info_1.update_user_branches)(current_user, deposit_amount, log_params.metadata.timestamp)];
            case 4:
                _a.sent();
                return [3 /*break*/, 6];
            case 5:
...
exports.user_deposit_handler = user_deposit_handler;
